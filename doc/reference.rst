...
.. _server_remote-unreachable-retry:

remote-unreachable-retry
------------------------

When a connection attempt times out to some remote address, this information will be
kept for this specified time and other connections to the same address won't
be attempted. This prevents repetitive waitig for timeout on an unreachable remote.
